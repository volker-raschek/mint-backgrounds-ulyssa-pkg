...
![AUR version](https://img.shields.io/aur/version/mint-backgrounds-ulyssa?label=AUR)
[![Build Status](https://drone.cryptic.systems/api/badges/volker.raschek/mint-backgrounds-ulyssa-pkg/status.svg)](https://drone.cryptic.systems/volker.raschek/mint-backgrounds-ulyssa-pkg)
![AUR votes](https://img.shields.io/aur/votes/mint-backgrounds-ulyssa)

This repository contains build files to build the Arch Linux package `mint-backgrounds-ulyssa`. Instead of building the
...
```bash
git clone https://aur.archlinux.org/mint-backgrounds-ulyssa.git
cd mint-backgrounds-ulyssa
makepkg
```
...
```bash
yay --sync --aur mint-backgrounds-ulyssa
```
...
sudo pacman --sync mint-backgrounds-ulyssa
```
